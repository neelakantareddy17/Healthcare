...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/patient/book/:id" element={<RoleRoute role="patient"><BookAppointment /></RoleRoute>} />      <Route path="/patient/bookings" element={<RoleRoute role="patient"><Bookings /></RoleRoute>} />      <Route path="/patient/booking-success" element={<RoleRoute role="patient"><BookingSuccess /></RoleRoute>} />
